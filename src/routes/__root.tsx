...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "صالون هارون — HAROUN | حلاقة رجالية فاخرة واحجز موعدك أونلاين" },
      { name: "description", content: "صالون هارون للحلاقة الرجالية الفاخرة. احجز موعدك أونلاين مع أمهر الحلاقين، خدمات قص وتهذيب لحية وحلاقة ملكية وباقات العرسان." },
      { name: "author", content: "Haroun Salon" },
      { name: "theme-color", content: "#1a1510" },
      { property: "og:title", content: "صالون هارون — HAROUN | حلاقة رجالية فاخرة" },
      { property: "og:description", content: "احجز موعدك في صالون هارون. تجربة حلاقة راقية بأيدي محترفين." },
